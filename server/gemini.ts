...
管理費収支について担当理事より報告があった。当期は収入が予算比+2.3%、支出が予算比−1.8%となり、黒字で着地した。修繕積立金の残高は現在9,600万円であり、来期の大規模修繕計画に向けて概ね計画通りの水準を維持している。

出席組合員より「修繕積立金の取り崩し予定について詳細を確認したい」との質問があり、担当理事より「第1回大規模修繕（外壁塗装・防水工事）を来年度実施予定で、費用は概算3,200万円を見込んでいる」旨の説明がなされた。

**採決：賛成多数により承認**

### 第2号議案：長期修繕計画の進捗確認

管理会社より、直近の修繕履歴および今後30年の計画概要が説明された。エレベーター定期点検は年4回実施しており、最新点検では異常なしの報告。外壁タイルの一部剥落が確認されたため、次回の定期点検時に補修の見積もりを取得する方針とした。
...
エントランスの自動ドア不具合（閉動作の遅延）について、管理会社より修繕見積もりが提出された。修繕費用は税込385,000円。修繕積立金より支出することで了承を得た。工事は来月中旬を予定。

**採決：賛成多数により可決**

### 第4号議案：その他

- 駐輪場ルールの周知徹底について：共用廊下への自転車放置が散見されるため、掲示板にて再度周知を図ることとした。
- 次回理事会の日程を調整し、来月第3週の土曜日午前10時に開催することで合意した。
...
1. 当期収支報告を承認する。
2. 長期修繕計画の方針を継続し、外壁補修の見積もりを次回までに取得する。
3. エントランス自動ドアの修繕（税込385,000円）を修繕積立金より支出する。
4. 駐輪場ルールの周知徹底を実施する。
5. 次回理事会を来月第3週土曜 10:00 に開催する。

---

## 次回予定

- **次回理事会：** 来月第3週 土曜日 午前10時
- **開催場所：** ${locationStr}
