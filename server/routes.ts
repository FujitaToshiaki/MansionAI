        ...
        "3125710f-b498-4949-86e2-b01bc9fcc13a": {
          ...
          revisions: [
            ...
            },
            {
              ...
              proposed_text: "総会の議事は、この法律に別段の定めがある場合を除いて、区分所有者の議決権の過半数で決する。\n\n二 総会及び共用部分の変更（その軽微又は軽微な新しい変更を伴わないものの区分建物の利用関係の改善に関する法律第25条第2項に掲げる変更を含む。）\n\n三 区分所有者又は86条第1項、第59条第1項又は第60条第1項の各の建設\n\n四 建物の建築又は2分の1を超える各区分所有者の承諾した共用部分の変更",
