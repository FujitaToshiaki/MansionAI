...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/condominiums/:id/decisions/:decisionId', async (req, res) => {
    try {
      const { id: condominiumId, decisionId } = req.params;
      ...
      const allDecisions = [
        {
          ...
          meetingType: '第40期通常総会',
          category: '大規模工事',
          agenda: '大規模修繕工事実施と修繕積立金特別徴収承認の件',
          result: '可決',
          details: '建物の老朽化に対応するため、外壁塗装、防水工事、給排水管改修を含む大規模修繕工事を実施することを決議。工事期間は6ヶ月を予定し、修繕積立金の不足分については特別徴収により対応する。',
          presenter: '理事長',
          location: '管理組合集会所',
          summary: '大規模修繕工事の実施と特別徴収を承認',
          votingResults: {
            favor: 42,
            against: 3,
            abstain: 2
          },
          relatedArticle: '管理規約第28条、第29条'
        },
        {
          id: 'decision-2',
          meetingDate: '2024年3月',
          ...
          category: 'ペット飼育',
          agenda: 'ペット飼育規則変更承認の件',
          result: '可決',
          details: '昨今のペット飼育環境の変化を踏まえ、ペット飼育規則を改正。犬・猫の飼育頭数制限の緩和、新たなペット種類（小動物）の許可条件を明確化した。',
          presenter: '理事',
          location: '管理組合集会所',
          summary: 'ペット飼育規則の変更を承認',
          votingResults: {
            favor: 38,
            against: 8,
            abstain: 1
          },
          relatedArticle: 'ペット飼育規則第3条、第4条'
        },
        {
          id: 'decision-3',
          meetingDate: '2023年9月',
          ...
          agenda: '旧管理人居室（103号室）の賃貸使用に伴う管理規約変更の件・使用細則変更の件',
          result: '可決',
          details: '旧管理人居室を有効活用するため、賃貸住宅としての使用を可能とする管理規約改正と、それに伴う使用細則の制定を行う。賃貸収入は管理組合収入として管理費軽減に充当する。',
          presenter: '理事長',
          location: '管理組合集会所', 
          summary: '旧管理人居室の賃貸使用に伴う規約・細則変更を承認',
          votingResults: {
            favor: 35,
            against: 5,
            abstain: 3
